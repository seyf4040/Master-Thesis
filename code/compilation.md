...
- [Files from current directory](#files-from-current-directory)
	...
	- [HuggingFace Model Performance](#huggingface-model-performance)
		...
		- [Datasets](#datasets)
			- [1. Kaggle Toxic Comment Challenge](#1-kaggle-toxic-comment-challenge)
			- [2. Wikipedia Attack](#2-wikipedia-attack)
			- [3. KoalaAI - Text Classification (empty ?)](#3-koalaai---text-classification-empty-)
		- [Models Under Evaluation](#models-under-evaluation)
			- [1. **EthicalEye** (autopilot-ai/EthicalEye)](#1-ethicaleye-autopilot-aiethicaleye)
			- [2. **KoalaAI Model**](#2-koalaai-model)
			- [3. **CitizenLab Model**](#3-citizenlab-model)
		- [Preliminary Results](#preliminary-results)
			- [Wikipedia attack](#wikipedia-attack)
			- [Kaggle Toxic Comment Classification Challenge](#kaggle-toxic-comment-classification-challenge)
		- [Observations](#observations)
			- [Wikipedia Attack Dataset](#wikipedia-attack-dataset)
			- [Kaggle Toxic Comment Classification Challenge](#kaggle-toxic-comment-classification-challenge)
		- [Summery](#summery)
